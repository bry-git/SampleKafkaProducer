 ...
 * this config class will gather the bootstrap server address from application.yml and provide a
 * KafkaTemplate class with the object from the producer factory method.
 * */
